...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen scroll-smooth bg-background pb-24 md:pb-0">
      ...
      <section className="mx-auto max-w-6xl px-6 pb-12 pt-16 md:pb-14 md:pt-20">
        <div className="grid items-center gap-12 md:grid-cols-2">
          <div>
            ...
            <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap md:flex-nowrap">
              <Button
                size="lg"
              ...
              <Button
                variant="outline"
                size="lg"
                className="text-muted-foreground sm:min-w-[180px] sm:flex-1 md:flex-none"
                asChild
              >
                <a href="#how-it-works">
                  See 2-min demo flow <ChevronDown className="ml-1 h-4 w-4" />
                </a>
              </Button>
            </div>
            <div className="flex items-center gap-3 text-xs text-muted-foreground">
              <span className="inline-flex items-center gap-1.5 rounded-full border bg-card px-2.5 py-1">
                ...
                <strong className="text-foreground">200+ SMB teams</strong> in pilot and live usage
              </span>
            </div>
          </div>
            ...
            <div className="space-y-3 rounded-xl border bg-card p-5 shadow-lg">
              ...
              <div className="space-y-1.5">
                {[
                  ...
                  <div key={lead.rank} className="flex items-center gap-3 rounded-lg border bg-background px-3 py-2">
      ...
      <div
        className={`fixed bottom-0 left-0 right-0 z-50 border-t bg-card/95 px-4 py-2 backdrop-blur-sm transition-opacity duration-200 md:hidden ${
